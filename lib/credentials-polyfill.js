...
navigator.credentials = {
   ...
   *            https://credentials.io/credentials?action=request
  ...
  request: function(query, options) {
    ...
    var requestUrl =
      options.requestUrl || 'https://credentials.io/requests?action=request';
   ...
   *            https://credentials.io/credentials?action=transmit
   */
   ...
   *            https://credentials.io/credentials?action=store
  ...
  store: function(identity, options) {
    ...
    var requestUrl =
      options.requestUrl || 'https://credentials.io/requests?action=store';
  ...
  registerDid: function(options) {
    ...
    var registrationUrl =
      options.registrationUrl || 'https://credentials.io/identities';
    var request = {
